...
// - Back of China -
 ...
 $(document).ready(function() {
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-alert').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-confirm').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-prompt').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-custom').on('click', function(){
        bootbox.dialog({
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-custom-h-content').on('click', function(){
        bootbox.dialog({
            title: "That html",
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#gsp-bootbox-custom-h-form').on('click', function(){
        bootbox.dialog({
            ...
            message:'<div class="row"> ' + '<div class="col-md-12"> ' +
                    ...
                    '<label class="form-radio form-icon gsp-modal-radio active"><input type="radio" autocomplete="off" name="awesomeness" value="Really awesome" checked> Really awesome</label>' +
                    '<label class="form-radio form-icon gsp-modal-radio"><input type="radio" autocomplete="off" name="awesomeness" value="Super awesome"> Super awesome </label> </div>' +
    ...
    // =================================================================
    $('#gsp-bootbox-zoom').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#gsp-bootbox-bounce').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#gsp-bootbox-ruberwobble').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#gsp-bootbox-flip').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#gsp-bootbox-lightspeed').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#gsp-bootbox-swing').on('click', function(){
        bootbox.confirm({
