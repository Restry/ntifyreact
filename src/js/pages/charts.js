...
// - Back of China -
 ...
 $(document).ready(function() {
    ...
    gauge.setTextField(document.getElementById("gsp-gauge-txt"));
    ...
    // http://omnipotent.net/jquery.sparkline/#s-about
    // =================================================================
    $("#gsp-sparkline-pie").sparkline([5, 12, 17 ,55], {
        type: 'pie',
        width: '55',
        height: '55',
    ...
    // Flot tooltip
    // =================================================================
    $("<div id='gsp-flot-tooltip'></div>").css({
        position: "absolute",
        display: "none",
        padding: "10px",
        color: "#fff",
    ...
    $("#gsp-flot-line").bind("plothover", function (event, pos, item) {

        if (item) {
            var x = item.datapoint[0].toFixed(2),  y = item.datapoint[1];
            $("#gsp-flot-tooltip").html("<p class='h4'>" + item.series.label + "</p>" + y)
                .css({top: item.pageY+5, left: item.pageX+5})
                .fadeIn(200);
        } else {
            $("#gsp-flot-tooltip").hide();
        }
