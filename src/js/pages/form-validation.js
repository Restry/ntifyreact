...
$(document).ready(function() {
	...
	// =================================================================
	$('#gsp-bv-bsc-tabs').bootstrapValidator({
		excluded: [':disabled'],
	...
	// =================================================================
	$('#gsp-bv-accordion').bootstrapValidator({
	...
	// =================================================================
	$('#gsp-bv-errorcnt').bootstrapValidator({
		message: 'This value is not valid',
		excluded: [':disabled'],
		feedbackIcons: faIcon,
		fields: {
	...
	// =================================================================
	$('#gsp-bvd-notempty').bootstrapValidator({
		message: 'This value is not valid',
		feedbackIcons: faIcon,
		fields: {
		username: {
	...
	$('#gsp-msk-date').mask('99/99/9999');
	$('#gsp-msk-date2').mask('99-99-9999');
	$('#gsp-msk-phone').mask('(999) 999-9999');
	$('#gsp-msk-phone-ext').mask('(999) 999-9999? x99999');
	$('#gsp-msk-taxid').mask('99-9999999');
	$('#gsp-msk-ssn').mask('999-99-9999');
	$('#gsp-msk-pkey').mask('a*-999-a999');
