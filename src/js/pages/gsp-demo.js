...
$(document).ready(function () {
    ...
    var demoSetBody         = $('#gsp-set'),
        demoSetIcon         = $('#gsp-set-icon'),
        demoSetBtnGo        = $('#gsp-set-btngo'),
    ...
    if (demoSetBody.length) {
        function InitializeSettingWindow(){
            // BOXED LAYOUT
            // =================================================================
            var boxedLayoutCheckbox     = document.getElementById('gsp-box-lay'),
                boxedLayoutImgBtn       = document.getElementById('gsp-box-img'),
                boxedLayoutImgBox       = $('#gsp-bg-boxed'),
                boxedLayoutBtnClose     = document.getElementById('gsp-close-boxed-img'),
                blurredBgList           = $('#gsp-blurred-bg'),
                polygonBgList           = $('#gsp-polygon-bg'),
                abstractBgList          = $('#gsp-abstract-bg');
            ...
            var effectList = 'easeInQuart easeOutQuart easeInBack easeOutBack easeInOutBack steps jumping rubber',
                animCheckbox = document.getElementById('gsp-anim'),
                transitionVal = document.getElementById('gsp-ease');
            ...
            // =================================================================
            // =================================================================
            var navbarFixedCheckbox = document.getElementById('gsp-navbar-fixed');
            ...
            // =================================================================
            // =================================================================
            var footerFixedCheckbox = document.getElementById('gsp-footer-fixed');
            ...
            // =================================================================
            // =================================================================
            var collapsedCheckbox   = document.getElementById('gsp-nav-coll'),
                navFixedCheckbox    = document.getElementById('gsp-nav-fixed'),
                navProfileCheckbox  = document.getElementById('gsp-nav-profile'),
                navShortcutCheckbox = document.getElementById('gsp-nav-shortcut'),
                navOffcanvasSB      = document.getElementById('gsp-nav-offcanvas'),
            ...
            // =================================================================
            // =================================================================
            var asdVisCheckbox      = document.getElementById('gsp-asd-vis'),
                asdFixedCheckbox    = document.getElementById('gsp-asd-fixed'),
                asdFloatCheckbox    = document.getElementById('gsp-asd-float'),
                asdPosCheckbox      = document.getElementById('gsp-asd-align'),
                asdThemeCheckbox    = document.getElementById('gsp-asd-themes');
            ...
            $('#gsp-theme').on('click', '.gsp-theme', function (e) {
                e.preventDefault();
                var el = $(this);
        ...
        var demoSetBody = $('#gsp-set-body'), demoSetBtn = $('#gsp-set-btn');
        $('html').on('click', function (e) {
            if (demoSetBody.hasClass('in')) {
                if (!$(e.target).closest('#gsp-set').length) {
        ...
        $('#gsp-btn-close-settings').on('click', function () {
            demoSetBtn.trigger('click')
        });
    };
});
