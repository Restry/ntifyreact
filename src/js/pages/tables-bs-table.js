...
$(document).ready(function() {
    ...
    jQuery.fn.bootstrapTable.defaults.icons = {
        paginationSwitchDown: 'gsp-pli-arrow-down',
        paginationSwitchUp: 'gsp-pli-arrow-up',
        refresh: 'gsp-pli-repeat-2',
        toggle: 'gsp-pli-layout-grid',
        columns: 'gsp-pli-check',
        detailOpen: 'gsp-psi-add',
        detailClose: 'gsp-psi-remove'
    }
    ...
    // http://bootstrap-table.wenzhixin.net.cn/
    // =================================================================
    var $table = $('#gsp-custom-toolbar'),	$remove = $('#gsp-delete-row');
